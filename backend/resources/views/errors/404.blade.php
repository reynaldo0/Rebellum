...
<body>
    ...
    <div class="bg-gray-100 h-screen w-full flex justify-center items-center">
        <div>
            <h1 class="text-center text-5xl font-bold tracking-widest">Akses Ditolak</h1>
        <center class="mt-5 m-auto">
            ...
            <div class=" tracking-widest mt-8">
                <span class="text-gray-500 block"><span class="text-5xl">4 0 4</span></span>
                <span class="text-gray-500 text-xl">Anda tidak memiliki izin untuk mengakses halaman ini!</span>

            </div>
        </center>
        <center class="mt-6">
            <a href="{{ route('articles.detail.index') }}"
                class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Kembali
            </a>
        </center>
        </div>
    </div>
